...
Artist.destroy_all
cafetacuba = Artist.create ({name:"Cafetacuba", birth_date:Date.parse("1989-09-77"), country:"Mexico", picture:"http://www.universalmusicmagazine.com/wp-content/uploads/2013/03/CTS.jpg",
...
zoe = Artist.create ({name:"Zoe", birth_date:Date.parse("1995-09-77"), country:"Mexico", picture:"http://img14.deviantart.net/c2ea/i/2006/310/5/0/zoe___oro_by_vr_gfx.jpg",
...
Song.create([
  ...
  realease_date:Date.parse("2007-09-77"), duration:3.10},
